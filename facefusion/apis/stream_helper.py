...
def update_video_encoder_bitrate(video_codec : VideoCodec, video_encoder : VpxEncoder | AomEncoder, bitrate : BitRate) -> None:
	if video_codec == 'av1':
		aom_encoder.update_bitrate(video_encoder, bitrate)

	if video_codec == 'vp8':
		vpx_encoder.update_bitrate(video_encoder, bitrate)
